...
namespace RecipesAPI2.Migrations
{
    ...
    [Migration("20241121001330_session")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipesAPI2.Auth.Model.RecipeUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RecipesAPI2.Data.Entities.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipesAPI2.Auth.Model.RecipeUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipesAPI2.Data.Entities.Ingredient", b =>
                {
                    ...
                    b.HasOne("RecipesAPI2.Auth.Model.RecipeUser", "user")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
